...
(function() {
  $(function() {
    $(".temhafull2-N1[id=\'feMhOS1MBk\']").each(function() {
      const $block = $(this);
...
(function() {
  $(function() {
    $(".temhafull2-N2[id=\'RtmhOs1MND\']").each(function() {
      const $block = $(this);
...
(function() {
  $(function() {
    $(".temhafull2-N3[id=\'ZqMHOs1Mtj\']").each(function() {
      const $block = $(this);
      // Swiper
      const swiper = new Swiper(".temhafull2-N3[id=\'ZqMHOs1Mtj\'] .contents-swiper", {
        autoHeight: true,
        slidesPerView: 1,
        spaceBetween: 0,
        parallax: true,
        ...
        navigation: {
          nextEl: ".temhafull2-N3[id=\'ZqMHOs1Mtj\'] .swiper-button-next",
          prevEl: ".temhafull2-N3[id=\'ZqMHOs1Mtj\'] .swiper-button-prev",
        },
        pagination: {
          el: ".temhafull2-N3[id=\'ZqMHOs1Mtj\'] .swiper-pagination",
          clickable: true,
          type: "bullets",
        },
      });
...
(function() {
  $(function() {
    $(".temhafull2-N4[id=\'YzmhoS1N0J\']").each(function() {
      const $block = $(this);
      // Swiper
      const swiper = new Swiper(".temhafull2-N4[id=\'YzmhoS1N0J\'] .contents-swiper", {
        slidesPerView: "auto",
        loop: true,
        spaceBetween: 0,
        pagination: {
          el: ".temhafull2-N4[id=\'YzmhoS1N0J\'] .swiper-pagination",
          clickable: true,
          type: "bullets",
        },
      });
...
(function() {
  $(function() {
    $(".temhafull2-N5[id=\'cFMhoS1n5B\']").each(function() {
      const $block = $(this);
      // Swiper
      const swiper = new Swiper(".temhafull2-N5[id=\'cFMhoS1n5B\'] .contents-swiper", {
        slidesPerView: "auto",
        // loop: true,    
        spaceBetween: 0,
        speed: 600,
...
(function() {
  $(function() {
    $(".temhafull2-N7[id=\'cvMHOs1nIo\']").each(function() {
      const $block = $(this);
      // Images List
